...
class StationsOneScreen extends ConsumerStatefulWidget {
  const StationsOneScreen({Key? key}) : super(key: key);

  @override
  StationsOneScreenState createState() => StationsOneScreenState();
}

class StationsOneScreenState extends ConsumerState<StationsOneScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: AppbarTitle(
        text: "lbl_stations".tr, // Add the title here
