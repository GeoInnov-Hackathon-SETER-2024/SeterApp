import 'notifier/sign_in_dark_one_notifier.dart';
...
class SignInDarkOneScreen extends ConsumerStatefulWidget {
  const SignInDarkOneScreen({Key? key}) : super(key: key);

  @override
  SignInDarkOneScreenState createState() => SignInDarkOneScreenState();
}

// ignore_for_file: must_be_immutable
class SignInDarkOneScreenState extends ConsumerState<SignInDarkOneScreen> {
    ...
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return CustomTextFormField(
              controller: ref.watch(signInDarkOneNotifier).nameController,
              hintText: "lbl_nom".tr);
        }));
  }
  ...
  Widget _buildPhone(BuildContext context) {
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return CustomTextFormField(
              controller: ref.watch(signInDarkOneNotifier).phoneController,
  ...
  Widget _buildEmail(BuildContext context) {
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return CustomTextFormField(
              controller: ref.watch(signInDarkOneNotifier).emailController,
  ...
  Widget _buildPassword(BuildContext context) {
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return CustomTextFormField(
              controller: ref.watch(signInDarkOneNotifier).passwordController,
  ...
  /// Section Widget
  Widget _buildSuivant(BuildContext context) {
